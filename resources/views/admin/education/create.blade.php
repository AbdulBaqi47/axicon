...
@section('styles')
    ...
    <title>Axiquo | Education - Create</title>
...
@section('content')
    ...
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-1 mb-3">
        <div>Education<span class="text-muted font-weight-light"> / Create</span></div>
    ...
    <div class="card">
        ...
        <div class="card-body pb-4">
            ...
            <div class="form-group">
                ...
                {{ Form::select('published', ['1' => 'Published', '0' => 'Draft'], '0', ['class' => 'custom-select']) }}
            </div>
