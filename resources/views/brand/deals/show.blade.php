...
@section('content')
    ...
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-1 mb-4">
        <div>Deals<span class="text-muted font-weight-light"> / {{ $deal->title }}</span></div>
        <button type="button" class="btn btn-secondary btn-round d-block" onclick="location.href='{{ url('/brand/deals') }}'">
        ...
        <div class="col-md-4 col-xl-3">
            ...
            <div class="card mb-4">
                ...
                <div class="card-footer">
                    @if ($deal->approved != '1')
                        <button type="button" class="btn btn-success" onclick="location.href='{{ url('/brand/deals/'.$deal->id.'/approve') }}'"><i class="ion ion-md-checkmark"></i>&nbsp; Approve Content</button>&emsp;
                    @else
                        <div class="text-success pt-1 pb-2">
                            <i class="ion ion-md-checkmark"></i>&nbsp; Content Approved
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex justify-content-between align-items-center mt-2 mb-1">
                        <textarea class="form-control" rows="10" readonly>{{ $deal->description }}</textarea>
                    </li>
                </ul>
            </div>
            <!-- / Brand details -->
    ...
    <div class="card mb-4">
        <h6 class="card-header">Creators</h6>
